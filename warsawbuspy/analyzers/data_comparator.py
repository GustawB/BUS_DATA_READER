...
class DataComparator:
    ...
    @staticmethod
    def __read_data_from_file(file_to_read_from, data_holder):
    ...
    def __write_data_to_file(self, file_to_write_into, column_names):
    ...
    def comp_data(self, file_to_read_1, file_to_read_2):
    ...
    def dump_data_comp_result(self, file_to_dump, column_names):
